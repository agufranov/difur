...
/* `sol:true` — «у задачи есть солитоны». Единственная фишка про поведение решений,
   ...
   руками и только там, где солитон виден с первого запуска. Сейчас таких семь:
   КдФ, мКдФ, Кавахара, НУШ, синус-Гордон, Манаков и φ⁴. У Клейн–Гордона солитон тоже
   есть (топологический кинк), но начальные данные пресета его не показывают —
